					...
					<div className="col-xl-6 col-lg-7">
						<div className="fugu-hero-content">
							<h1 className="wow fadeInUpX" data-wow-delay="0s">
								Unleash the power of web3 marketing with 2024BULLRUN.com
							</h1>
							<p className="wow fadeInUpX" data-wow-delay="0.25s">
							We help you connect directly with web3 Influencers, organising IRL Events and provide quality PR & Media! 
							</p>
